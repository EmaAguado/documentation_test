...
from task_schema.plugins.anniecarolanew_plugin import AnnieCarolaNewPlugin
...
class AnniecarolaPluginTests(unittest.TestCase):
    ...
    def test_get_shots(self):
        self.p.get_all_tasks_data(
            self.all_task_data, force_no_cache=True, **{"sg_entity_type": "Shot"}
        )
        # self.p.last_task_clicked = self.all_task_data["results"][0][0]
        pprint(self.all_task_data)
